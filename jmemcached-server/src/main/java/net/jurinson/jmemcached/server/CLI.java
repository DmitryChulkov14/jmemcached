...
import net.jurinson.jmemcached.server.impl.JMemcachedServerFactory;
...
public class CLI {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            LOGGER.error("Can't execute cmd: " + e.getMessage());
        }
    }
        ...
        try(Scanner scanner = new Scanner(System.in, StandardCharsets.UTF_8.name())){
            while (true){
                ...
                if (QUIT_CMDS.contains(cmd.toLowerCase())){
                    ...
                    LOGGER.error("Unsupported cmd: " + cmd + ". To shutdown server please type: " + QUIT_CMDS.toString());
                }
            }
        }
    }
