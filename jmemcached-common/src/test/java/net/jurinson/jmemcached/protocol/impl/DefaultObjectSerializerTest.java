...
public class DefaultObjectSerializerTest {
    ...
    private final byte[] testClassNotFoundArray = {-84, -19, 0, 5, 115, 114, 0, 3, 97, 46, 66, 56, 54, 57, -101, -3, 120, 66, 4, 2, 0,
            0, 120, 112};

    // Byte array from test.SeriazableFailedClass instance
    private final byte[] testIOExceptionDuringDeserialization = {-84, -19, 0, 5, 115, 114, 0, 26, 116, 101, 115, 116, 46, 83, 101, 114,
            105, 97, 122, 97, 98, 108, 101, 70, 97, 105, 108, 101, 100, 67, 108, 97, 115, 115, -21, -110, -27, 28, 43, -101, 0, -74, 2,
            0, 0, 120, 112};
