...
public class DefaultClientTest {
    ...
    public void putSimple() throws IOException {
        ...
        verify(requestConverter).writeRequest(same(out), equalsTo(new Request(Command.PUT, key, null, array)));
    }
    ...
    public void putFull() throws IOException {
        ...
        Status status = defaultClient.put(key, value, 1, TimeUnit.DAYS.MILLISECONDS);

        assertEquals(Status.REPLACED, status);
        verify(objectSerializer).toByteArray(value);
        verify(requestConverter).writeRequest(same(out), equalsTo(new Request(Command.PUT, key, 1L, array)));
    }
    ...
    public void get() throws IOException {
        ...
        verify(requestConverter).writeRequest(same(out), equalsTo(new Request(Command.GET, key)));
    }
    ...
    public void remove() throws IOException {
        ...
        verify(requestConverter).writeRequest(same(out), equalsTo(new Request(Command.REMOVE, key)));
    }
    ...
    public void clear() throws IOException {
        ...
        verify(requestConverter).writeRequest(same(out), equalsTo(new Request(Command.CLEAR)));
    }
    ...
    private Request equalsTo(final Request request){
